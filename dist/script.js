...
document.addEventListener('DOMContentLoaded', function () {
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_0__["default"])('.button-design', '.popup-design');
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_0__["default"])('.button-consultation', '.popup-consultation');
  Object(_modules_modal__WEBPACK_IMPORTED_MODULE_0__["default"])('.fixed-gift', '.popup-gift');
});
...
function closeModal(timerModal) {
  var modal = document.querySelector('body > div[class*=popup][class~=active]');
...
function modal(triggerSelector, modalSelector, windowData, timerModal) {
  var btnShowModal = document.querySelectorAll(triggerSelector),
      modal = document.querySelector(modalSelector),
      errorMessage = document.createElement('div'); // errorMessage.className = "status";	
